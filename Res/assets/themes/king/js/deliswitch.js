...
jQuery(document).ready(function ($) {
	...
	var skinLogoDefault = '/assets/img/trainingadmin-logo-white.png';
	...
	$('.switch-skin, .switch-skin-full').click(function (e) {
		...
		if ($(this).hasClass('fullbright')) {
			skinLogo = '/assets/img/trainingadmin-logo.png';
		} else {
	...
	function resetStyle() {
		...
		$('.logo img').attr('src', '/assets/img/trainingadmin-logo-white.png');
