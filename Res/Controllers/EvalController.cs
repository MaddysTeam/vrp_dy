...
namespace Res.Controllers
{
	...
	public class EvalController : BaseController
	{
		...
		public ActionResult Details(long id, long resId, long? courseId, long groupId, long? expertId)
		{
			...
			ViewBag.isSlef = true;// (string.IsNullOrEmpty(expId) ? 0 : Convert.ToInt32(expId)) == ResSettings.SettingsInSession.UserId || (id == 0 && expert.UserTypePKID == ResUserHelper.Export);
